<?php
    ...
    // class & ID
    $section_class = 'pagebuilder-section pagebuilder-section-image-library';
    $section_id = '';
...
<section
    ...
    <?php if(get_sub_field('section_heading')) : ?>
        <div class="row section-heading">
            <?php echo sprintf('<img class="section-heading-image" src="%spagebuilder/camera-retro-icon.svg" class="" />', trailingslashit( THEME_IMG ) ); ?>
            <h2 class="element-heading"><?php echo get_sub_field('section_heading'); ?></h2>
        </div>
    <?php endif; ?>
            ...
            <article class="image">
                ...
                <div class="image-container">
                    ...
                    <div class="image-content-container">
                        <div class="image-content-container-inner">
                            <?php if(get_sub_field('image_title')) : ?>
                                <div class="image-content">
                                    <div class="image-title-row">
                                        <div class="image-content-icon-container">
                                            <?php echo sprintf('<img class="image-content-icon" src="%spagebuilder/camera-retro-icon.svg" class="" />', trailingslashit( THEME_IMG ) ); ?>
                                        </div>
                                        <h3 class="image-title"><?php echo get_sub_field('image_title'); ?></h3>
                                    </div>
                                    <?php if(get_sub_field('image_title') && get_sub_field('image_caption')) : ?>
                                        <div class="image-caption"><?php echo get_sub_field('image_caption'); ?></div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <button class="image-modal-link button-unstyle" data-src="<?php echo wp_get_attachment_image_src( get_sub_field('image')['ID'], $size = 'full' )[0]; ?>"><?php echo sprintf('<img class="image-modal-link-image" src="%spagebuilder/expand-icon.svg" class="" />', trailingslashit( THEME_IMG ) ); ?></button>
                        </div>
                    </div>
    ...
    <div class="row slick-navigation-container slick-arrows">
